                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-sm-12 text-center">
                                            <h2 class="text-muted mb-0">   <i class="fe-check-square"></i> &nbsp &nbsp Points Have Successffully Been Approved as Cash<br><br> <a href="{{url('logindonor')}}" class="text-dark ml-1"><b>Sign In</b></a></h2>
                                        </div>
                                    </div>
